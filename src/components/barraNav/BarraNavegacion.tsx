        ...
        <ul className="nav nav-pills">
            ...
            <Dropdown>
                ...
                <Dropdown.Menu>
                    ...
                    <Dropdown.Item className="link-dos" href="#/action-2">Another action</Dropdown.Item>
                    <Dropdown.Item className="link-dos" href="#/action-3">Something else</Dropdown.Item>
                </Dropdown.Menu>
            </Dropdown>
